...
internal static class WebInvasionLocalization
{
    ...
    private static readonly Dictionary<string, (string En, string Ja)> Texts = new(StringComparer.Ordinal)
    {
        ...
        ["base_reward"] = ("Base reward", "通常報酬"),
        ["brought_home"] = ("Brought home", "持ち帰り"),
        ["invasion.result.performance.clean"] = ("Clean Clear", "無犠牲攻略"),
        ["invasion.result.performance.controlled"] = ("Controlled Clear", "損耗抑制"),
        ["invasion.result.lesson.success"] = ("The formation cleared the hostile dungeon objective. Compare the performance bonus before choosing the next target.", "敵ダンジョンの攻略目標を達成しました。攻略評価と追加報酬を確認して次の侵攻先を選びます。"),
